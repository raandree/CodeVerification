@{
    ...
    FunctionsToExport = 'Invoke-AzureDevOpsTasksGit'
    ...
    AliasesToExport   = @('Task.Create_PR_From_SourceBranch','Task.Create_AzureDevOps_Release')
