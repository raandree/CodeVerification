...
@{
    ...
    FunctionsToExport    = @('Add-AADConnectDirectoryExtensionAttribute','Convert-ObjectToHashtable','Get-AADConnectDirectoryExtensionAttribute','Get-ADSyncRule','Remove-AADConnectDirectoryExtensionAttribute','Write-AADConnectEventLog')

    # Variables to export from this module
    VariablesToExport    = @()

    # DSC resources to export from this module
    DscResourcesToExport = @('AADSyncRule','AADConnectDirectoryExtensionAttribute')
